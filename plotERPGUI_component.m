...
sideGrid = uigridlayout(sidePanel, [10, 1]); % Define sections within the side panel


% Right Panel
sidePanel2 = uipanel(mainGrid, ...
                     'Tag','RightPanel', ...
                     'BackgroundColor', [0.94 0.94 0.94]);
rightGrid = uigridlayout(sidePanel2, [5, 1]); % Define sections for topoplots and other controls
