...
function plotERPGUI(events)
    ...
    mainFig = figure('Name', 'ERP Analysis Tool', ...
                    ...
                    'MenuBar', 'none', ...
                    'ToolBar', 'none',...
                    'WindowButtonDownFcn', @startDragSelection);%, 'WindowButtonUpFcn', @mouseUp);
    ...
    plotPanel = uipanel('Parent', mainFig, ...
                       ...
                       'ButtonDownFcn',@startDragSelection);
    ...
    axes1.ButtonDownFcn = @startDragSelection;
    axes2.ButtonDownFcn = @startDragSelection;
...
function updatePlot(source, ~)
    ...
    cla(userData.axes1,'reset');
    cla(userData.axes2,'reset');
    ...
    %set()
    mainFig.WindowButtonDownFcn = @startDragSelection;
    %userData.axes1.ButtonDownFcn = @startDragSelection;
    %userData.axes2.ButtonDownFcn = @startDragSelection;
...
function plotEventERP(EEG, eventType, timeWindow, selectedChannels)
    ...
    %set(h(1).Parent.ButtonDownFcn, @startDragSelection);
    ax = h(1).Parent.Parent
    ax.ButtonDownFcn = @startDragSelection,ax
...
function startDragSelection(src, ~)
    ...
    ax = mainFig.Children(1).Children(1)
...
function mouseDown(~, ~)
    ...
    set(gcf, 'WindowButtonMotionFcn', @mouseMove,startPoint); % Set movement function
end

function mouseMove(src, startPoint)
